...
describe('Employee e2e test', () => {
  ...
  describe('new Employee page', () => {
    ...
    it('should create an instance of Employee', () => {
      cy.get(`[data-cy="name"]`).type('Strategist Synergized metrics').should('have.value', 'Strategist Synergized metrics');

      cy.get(`[data-cy="phone"]`).type('514-981-3797').should('have.value', '514-981-3797');

      cy.get(`[data-cy="idType"]`).select('PASSPORT');

      cy.get(`[data-cy="idNumber"]`).type('Texas Illinois').should('have.value', 'Texas Illinois');
